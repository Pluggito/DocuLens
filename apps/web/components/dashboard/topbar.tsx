  ...
  return (
    <header className="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200/60 sticky top-0 z-30 flex items-center justify-between px-6 lg:px-10">
      ...
      <div className="flex items-center gap-4 ml-4">
        ...
        <div className="h-8 w-8 rounded-full bg-slate-900 flex items-center justify-center text-white font-medium shadow-sm cursor-pointer hover:shadow-md transition-shadow">
          <User size={16} />
        </div>
      </div>
    </header>
